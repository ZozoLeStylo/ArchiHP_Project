...
set output 'res.cache-miss-latency.pdf'
...
#set output 'res.cache-miss-latency.gif'
set style data linespoints
set key below
set title 'res.cache-miss-latency'
...
'res.cache-miss-latency.data' using 1:($7-2.740000) title '16' with linespoints lt 1 pt 3 , \
'res.cache-miss-latency.data' using 1:($13-2.740000) title '8' with linespoints lt 2 pt 4
set nolabel
set noarrow
